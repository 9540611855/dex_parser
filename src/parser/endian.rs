...
pub trait EndianParse{
    ...
    fn parse_u8_at(self, offset: &mut usize, data: &[u8]) ->u8 where Self: Sized{
    ...
    fn parse_u16_at(self,offset:  &mut usize, data: &[u8]) ->u16 where Self: Sized{
    ...
    fn parse_u32_at(self,offset: &mut usize, data: &[u8]) ->u32 where Self: Sized{
    ...
    fn parse_u64_at(self,offset: &mut usize, data: &[u8]) ->u64 where Self: Sized{
    ...
    fn parse_i32_at(self, offset: &mut usize, data: &[u8]) -> i32 where Self: Sized {
    ...
    fn parse_i64_at(self,offset:  &mut usize, data: &[u8]) -> i64 where Self: Sized{
